...
st.markdown(
    ...
    <style>
        ...
        :root {
            --seed-green: #167a52;
            --seed-green-dark: #0e5f3f;
            --seed-green-soft: #eaf7f1;
            --seed-bg: #f6f8f7;
            --seed-card: #ffffff;
            --seed-border: #e2e8e4;
            --seed-text: #14231d;
...
def auth_page():
    ...
    with center:
        ...
        st.markdown('<div class="seed-eyebrow">🌿 SEED LAB</div>', unsafe_allow_html=True)
        st.markdown(
            '<div class="auth-title">Multimodal Data QC Studio</div>',
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="auth-subtitle">Secure workspace for annotation, AI processing and quality control.</div>',
            unsafe_allow_html=True,
        )
...
def sidebar(user):
    with st.sidebar:
        st.markdown(
            '<div class="seed-eyebrow" style="color:#78d4aa;">🌿 SEED LAB</div>',
            unsafe_allow_html=True,
        )
...
def page_header(eyebrow, title, subtitle=""):
    st.markdown(
        f'<div class="seed-eyebrow">{eyebrow}</div>',
        unsafe_allow_html=True,
    )
    st.title(title)
    ...
    if subtitle:
        st.markdown(
            f'<div class="seed-muted">{subtitle}</div>',
            unsafe_allow_html=True,
        )
